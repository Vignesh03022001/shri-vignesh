...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center pt-20 pb-10 px-4 md:px-8 lg:px-16 w-full">
      <div className="mx-auto staggered-animation">
        ...
        <p className="text-lg md:text-xl mb-8 text-portfolio-navy about-me-hero-section">
