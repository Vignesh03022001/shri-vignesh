      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 bg-white dark:bg-portfolio-navy p-6 rounded-lg shadow-md">
            <form>
              <div className="mb-4">
                <label htmlFor="name" className="block text-portfolio-navy dark:text-portfolio-lightestSlate mb-2">Name</label>
                <input 
                  type="text" 
                  id="name" 
                  className="w-full px-4 py-2 rounded border border-slate-300 dark:border-portfolio-lightNavy bg-white dark:bg-portfolio-lightNavy text-portfolio-navy dark:text-portfolio-lightestSlate focus:outline-none focus:ring-2 focus:ring-portfolio-highlight"
                />
              </div>
              <div className="mb-4">
                <label htmlFor="email" className="block text-portfolio-navy dark:text-portfolio-lightestSlate mb-2">Email</label>
                <input 
                  type="email" 
                  id="email" 
                  className="w-full px-4 py-2 rounded border border-slate-300 dark:border-portfolio-lightNavy bg-white dark:bg-portfolio-lightNavy text-portfolio-navy dark:text-portfolio-lightestSlate focus:outline-none focus:ring-2 focus:ring-portfolio-highlight"
              ...
              <div className="mb-4">
                <label htmlFor="message" className="block text-portfolio-navy dark:text-portfolio-lightestSlate mb-2">Message</label>
                <textarea 
                  id="message" 
                  rows={4}
                  className="w-full px-4 py-2 rounded border border-slate-300 dark:border-portfolio-lightNavy bg-white dark:bg-portfolio-lightNavy text-portfolio-navy dark:text-portfolio-lightestSlate focus:outline-none focus:ring-2 focus:ring-portfolio-highlight"
